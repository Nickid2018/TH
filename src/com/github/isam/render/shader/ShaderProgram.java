...
public class ShaderProgram {
    ...
    public static ShaderProgram createFromJAR(String vs, String fs, Uniform... uniforms) throws IOException {
        String vss = IOUtils.toString(Objects.requireNonNull(ShaderProgram.class.getResource(vs)), Charsets.UTF_8);
        String fss = IOUtils.toString(Objects.requireNonNull(ShaderProgram.class.getResource(fs)), Charsets.UTF_8);
