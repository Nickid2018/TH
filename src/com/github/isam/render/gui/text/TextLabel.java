...
public class TextLabel extends TextComponent {
    ...
    public TextLabel(Renderer renderer, AABB position, VectorFont font) {
        super(renderer, position, font);
    }

    public TextLabel(Renderer renderer, AABB position, VectorFont font, String text) {
        super(renderer, position, font, text);
    }

    public TextLabel(Renderer renderer, AABB position, VectorFont font, String text, int color) {
